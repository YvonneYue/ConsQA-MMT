...
class Trainer(object):
    ...
    @property
    def ema(self): #指数参数平均：利用过去参数的加权平均来影响当前的参数值
    ...
    def train_step(self, samples, epoch, raise_oom=False):
        ...
        # 添加当前的 epoch 值到 extra_kwargs
        extra_kwargs["epoch"] = epoch
    ...
    def valid_step(self, sample,epoch, raise_oom=False):
