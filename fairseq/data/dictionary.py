...
class Dictionary:
        ...
        *,  # begin keyword-only arguments
        ...
        if extra_special_symbols:
            for s in extra_special_symbols:
                self.lang_index.append(self.add_symbol(s))
        ...
        print("self.lang_index", self.lang_index) # [#,#]
    ...
    def lang_symbol(self):
        """Helper to get index of unk symbol"""
        return self.lang_index #应该是一个列表，存储的是不同语言标识符的index
